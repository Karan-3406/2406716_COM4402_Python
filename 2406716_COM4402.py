...
# Dictionary storing questions for Quiz
quizQuestions = [
    {
...
# if question is multiple choice based, do
...
while menuChoice != 0:
    if menuChoice == 1:
        ...
        print(f"That's {((currentScore/len(quizQuestions))*100):.2f}%")
